...
sed -i "s/bucket: gpmrustfs/bucket: gpmbucket$2/g" config/thanos/bucket_config.yml
scp -r config/thanos root@$PROMETHEUS_SERVER:/opt/config/
sed -i "s/bucket: gpmbucket$2/bucket: gpmrustfs/g" config/thanos/bucket_config.yml
